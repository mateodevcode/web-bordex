...
function BotonLeerMas() {
  ...
  return (
    <div className="sm:hidden smd:hidden md:flex md">
      <button
        className="sm:flex sm:justify-center sm:items-center sm:w-80 smd:w-auto rounded-full border border-gray-500 sm:mb-0 md:mb-8 md:mt-8 lg:mb-12 xl:mb-16 flex items-center justify-center w-auto bg-white/5 hover:bg-white/10"
        onClick={openModal}
      >
